...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between gap-2 px-4',
      ...
      'focus:shadow-[var(--inset-sm),var(--glow-sm)]',
      // Disabled
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 text-[var(--text-muted)] shrink-0 transition-transform duration-200 group-data-[state=open]:rotate-180" />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ...
    className={cn(
      'py-2 px-3',
      'text-[var(--text-xs)] font-medium uppercase tracking-[var(--tracking-caps)]',
